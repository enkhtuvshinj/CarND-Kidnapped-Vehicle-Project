...
/**
 * Struct representing one transformed observation measurement.
 */
struct TransformedObs {
  struct LandmarkObs obs;  	// LandmarkObs
  int vec_id;				// Id of matching landmark in the prediction vector.
};
